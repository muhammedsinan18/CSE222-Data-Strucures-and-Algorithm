...
public class BreadthFirstSearch {
    ...
    /**
     * It takes an integer and an array of integers as parameters and returns true if the integer is in the array and false
     * otherwise
     *
     ...
     */
    private static boolean find(int Id, ArrayList<Integer>  array){
